...
using Aspose.Cells;
using CinemaTicketsAdmin_2021.Models;
...
namespace CinemaTicketsAdmin_2021.Controllers
{
    public class OrderController : Controller
    {
            ...
            using (var workbook = new XLWorkbook())
            {
                ...
                for (int i = 1; i <= result.Count(); i++)
                {
                    ...
                    for (int p = 0; p < item.TicketsInOrder.Count(); p++)
                    {
                        ...
                        worksheet.Cell(i + 1, p + 3).Value = item.TicketsInOrder.ElementAt(p).SelectedTicket.MovieId;
                    }
                }
        ...
        public FileContentResult CreateInvoice(Guid id)
        {
            ...
            foreach (var item in result.TicketsInOrder)
            {
                ...
                sb.AppendLine(item.SelectedTicket.Date + " with quantity of: " + item.Quantity + " and price of: " + item.SelectedTicket.Price + "$");
            }
